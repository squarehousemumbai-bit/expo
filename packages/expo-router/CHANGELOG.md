...
- Honor `unstable_settings.initialRouteName` when screens are explicitly declared in a layout. ([#48708](https://github.com/expo/expo/pull/48708) by [@Ubax](https://github.com/Ubax))

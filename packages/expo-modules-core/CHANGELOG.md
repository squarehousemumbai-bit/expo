...
- Added `getNativeRef()` to views created with `requireNativeView`. ([#48788](https://github.com/expo/expo/pull/48788) by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))
...
- Fixed hosted SwiftUI and Compose views ignoring React Native's `blur` view command, which a `ScrollView` and `Keyboard.dismiss()` use to blur the focused input. ([#48788](https://github.com/expo/expo/pull/48788) by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))

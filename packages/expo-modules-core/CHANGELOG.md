...
- Added `getNativeRef()` to views created with `requireNativeView`. ([#XXXXX](https://github.com/expo/expo/pull/XXXXX) by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))
...
- Fixed hosted SwiftUI and Compose views ignoring React Native's `blur` view command, which a `ScrollView` and `Keyboard.dismiss()` use to blur the focused input. ([#XXXXX](https://github.com/expo/expo/pull/XXXXX) by [@intergalacticspacehighway](https://github.com/intergalacticspacehighway))
